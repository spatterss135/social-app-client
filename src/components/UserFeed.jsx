...
export default function UserFeed({posts, userDB, setUserDB, setUser,  user, setPosts,  setUserPagePosts, likes, setLikes}){
    ...
    let individualPosts = posts.map((post, index) => {
        ...
        // let postLikes = likes.filter(like=> like.post_id === post.post_id)
        return(
